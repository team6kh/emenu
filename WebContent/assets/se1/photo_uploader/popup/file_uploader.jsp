...
String path = request.getSession().getServletContext().getRealPath("/") + File.separator + "/assets/se1/notice_upload"; // 이미지가 저장될 주소
//String path = "C:/team6/jogiyo/board/se1/notice_upload";
