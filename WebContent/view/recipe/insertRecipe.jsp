				...
				<table class="table table-striped">
					...
					<tr>
						...
						<td colspan="3" align="left">
						  <input type="text" name="recipe_subject" id="recipe_subject" maxlength="100" value="${resultClass.recipe_subject}" required /></td>
					</tr>
					<tr>
						<td style="width: 20%;" align="center">요리명</td>
						<td colspan="3" align="left">
						  <input type="text" name="recipe_foodsubject" id="recipe_foodsubject" maxlength="100" value="${resultClass.recipe_foodsubject}" required /></td>
					</tr>
					...
					<tr>
						<td style="width: 20%;" align="center">작성자</td>
						<td colspan="3" align="left">
							<input type="text" name="recipe_writer" id="recipe_writer" value="${resultClass.recipe_writer}" maxlength="60" required />
						</td>
					</tr>
					</c:if>
					...
					<tr>
						...
						<td colspan="3" align="left">
							<input type="password" name="recipe_password" id="recipe_password" value="${resultClass.recipe_password}" maxlength="60" required />
						</td>
					</tr>
					<tr>
						<td style="width: 20%;" align="center">재료</td>
						<td colspan="3" align="left">
							<input type="text" size="100" maxlength="100" name="recipe_method" id="recipe_method" value="${resultClass.recipe_method}" required />
						</td>
					</tr>
					<tr>
						<td style="width: 20%;" align="center">소요 시간</td>
						<td align="left">
							<input type="text" name="recipe_time" id="recipe_time" value="${resultClass.recipe_time}" maxlength="10" required />&nbsp;&nbsp;분</td>
						<td style="width: 20%;" align="center">비용</td>
						<td align="left">
							<input type="text" name="recipe_price" id="recipe_price" value="${resultClass.recipe_price}" maxlength="15" required />&nbsp;&nbsp;원</td>
					</tr>
					<tr>
					
						<td style="width: 20%;" align="center">방법 및 상세내용</td>
						<td colspan="3">
					    	<textarea name="recipe_content" maxlength="4000" id="recipe_content" Style="width:850px">${resultClass.recipe_content}</textarea>
					    </td>
					</tr>
