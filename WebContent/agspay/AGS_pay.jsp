...
<table border=0 width=100% height=100% cellpadding=0 cellspacing=0>
	<tr>
		...
		<table width=650 border=0 cellpadding=1 cellspacing=1>
			<tr><td>&nbsp;</td></tr>
			<tr><td class=clsleft><font color=red size=5><b>상품 주문 페이지</b></font></td></tr>
			<tr><td>&nbsp;</td></tr>
			<tr>
				<td class=clsleft>
					<!-- 히든값들 -->
					<input type=hidden style=width:100px name=StoreId maxlength=20 value="aegis"></td>
			...
			<tr>
				...
				<table width=650 border=0 cellpadding=0 cellspacing=0>
					...
					<tr>
						<td class=clsleft colspan=3><font color=#006C6C size=3><br/><b>결제자</b></font></td>
					</tr>
					<tr>
					...
					<tr>
						<td class=clsleft colspan=3><font color=#006C6C size=3><br/><b>결제 방식</b></font></td>
					</tr>
					<tr>
						<td width=170 class=clsleft><font color=red>*</font> 결제 방식</td>
						<td width=300>
